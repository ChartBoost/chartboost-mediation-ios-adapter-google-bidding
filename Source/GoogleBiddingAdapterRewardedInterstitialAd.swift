...
final class GoogleBiddingAdapterRewardedInterstitialAd: GoogleBiddingAdapterAd, PartnerFullscreenAd {
    ...
    func load(with viewController: UIViewController?, completion: @escaping (Error?) -> Void) {
        ...
        RewardedInterstitialAd.load(with: adm) { [weak self] ad, error in
...
extension GoogleBiddingAdapterRewardedInterstitialAd: FullScreenContentDelegate {

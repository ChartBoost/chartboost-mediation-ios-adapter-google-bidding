Pod::Spec.new do |spec|
  ...
  # Source
  spec.module_name  = 'HeliumAdapterGoogleBidding'
  spec.source       = { :git => 'https://github.com/ChartBoost/helium-ios-adapter-google-bidding.git', :tag => '#{spec.version}' }
